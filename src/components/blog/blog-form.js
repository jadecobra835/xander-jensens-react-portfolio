...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://xanderjensen.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        };
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({
                ...
                apiUrl: `https://xanderjensen.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
                apiAction: "patch"
            });
        };
    };
    ...
    handleRichTextEditorChange(content) {
        // Modern Javascript allows you to set "state.content" to "argument.content",
        // (Both are just called content noramlly) and because they share the same name,
